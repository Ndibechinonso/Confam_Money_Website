...
export const teamArray = [
  {
    ...
    name: "Adenike Cecilia Ayoola",
    position: "Manager",
  },
  {
    image: "/images/team_2.png",
    name: "Jude Aaron Osasse",
    position: "Administrator",
  },
  {
    image: "/images/team_3.png",
    name: " Ikechukwu David Anya",
    position: "Data Specialist",
  },
  {
    image: "/images/team_4.png",
    name: "Ikechukwu David Anya",
    position: "Underwriting Counselor",
  },
  {
  ...
  {
    image: "/images/team_8.png",
    name: "Barakat Omoniyi",
...
export const homeWhyUs = [
  ...
  },
  {
    ...
    title: "Mobile App",
    body: "We promise to continue to strive for mastery and continues development.",
  },
  {
...
export const homeCoreValues = {
  ...
  subtitle:
    "Our values as an esteemed third-party Payment security service provider, align to ensure customers and users have a unique experience, We remain committed to creating ease by bridging the gaps between the sellers, buyers, goods, and services.",
  cards: [
    {
      img: "/images/core_opacity.svg",
      title: "Transparency",
      sub: "We ensure transactions void of ambiguity in all forms.",
    },
    {
    ...
    },
    {
      ...
      title: "Dependability",
      sub: "We run a system with strong measures of security, availability and timeliness.",
    },
    {
...
export const comfamGridArray = [
  ...
  },
  {
    ...
    title: "Buyer deposit money with Confam Money",
...
export const terms_condition = {
  ...
  terms: [
    ...
    },
    {
      ...
      content:
        "ConfamMoney.com will create, issue, and verify a digital identification (a 'Digital ID') for each User which will be attached to every electronic document and notification e-mails by that User. The Digital ID is the User’s 'Electronic Signature.' ",
    },
    {
      title: "Fees",
      content:
    ...
    },
    {
      title: "Assignability",
      content:
        "confamMoney.com may assign this Agreement to any current or future affiliated company and to any successor in interest. confamMoney.com also may delegate certain of its rights and responsibilities under the Agreement to independent contractors or other third parties.",
    },
    {
      title: "Consent",
      content:
        "If you are a registered User of the Site, then each time you request the Services will constitute your agreement to these Terms of Use, as amended from time to time in confamMoney.com’s sole discretion, and evidence that you have read, understood and accepted the then applicable Terms of Use.",
    },
  ],
};
