...
<p className="mr-1 m-auto text-center max-w-[322px] px-[1.125rem] md:max-w-[900px] leading-[1.5rem] md:leading-[1.875rem] text-grey_2 text-[1rem] md:text-[1.25rem] mb-[9.375rem] md:mb-[14.25rem]">We can be reached directly via our customer service lines, you can also send us a mail for prompt 
mediation and resolution.<span><Link href="/contact"><a className="text-scam_contact font-medium">Contact.</a></Link></span></p>
</main>
        </>
    )
}
