...
const Testimonials = () => {
  return (
    <div className="px-[1.125rem] md:px-[6.25rem] flex flex-col gap-[70px] lg:flex-row items-center justify-between">
      <Image src="/images/testimonial_img.png" width={605} height={442} />
      <div className="max-w-[312px] md:max-w-[503px]">
        <h4 className="text-primary_5 font-semibold text-center text-[1.125rem] md:text-[1.5rem] mb-[1rem] md:mb-[1.5rem]">
        ...
        <div className="flex flex-row justify-between">
          <div className="flex flex-col gap-[6px] items-center font-semibold">
            <p className="text-primary_5 text-[1.25rem] md:text-[2.5rem] leading-[1.875rem] md:leading-[3rem]">
              4.7/5.0
            </p>
            <p className="text-black_2 text-[0.875rem] md:text-[1.25rem] leading-[1.5rem] md:leading-[1.875rem]">
              Customer Rating
            </p>
          </div>
          <div className="flex flex-col gap-[6px] items-center font-semibold">
