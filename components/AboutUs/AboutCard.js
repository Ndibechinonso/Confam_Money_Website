const AboutCard = ({header, text, containerClass}) =>{
    return(
        <div className={` ${containerClass} h-[500px] max-w-[332px] md:max-w-[600px] text-black_2 shadow-2xl rounded-2xl pt-[2.5rem] md:pt-[4rem] pb-[1.25rem] md:pb-[11rem] px-[1.875rem]`}>
