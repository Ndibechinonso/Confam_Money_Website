...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 [clip-path:polygon(0_0,_100%_0%,_100%_54%,_0_89%)] bg-homeheroedgemobile bg-homeheromb lg:bg-homeheroedge lg:bg-homeherolg bg-no-repeat ">
        <div
