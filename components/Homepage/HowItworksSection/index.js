...
function HowItworksSection() {
  ...
  return (
    <article className="pt-8 pb-[60px] px-6 bg-homesection lg:bg-homesection_desk bg-no-repeat bg-howitworkssm sm:bg-howitworksmd  lg:bg-howitworksxl lg:px-[100px] lg:pt-20 lg:pb-[200px] ">
