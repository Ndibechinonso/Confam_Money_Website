 ...
 <div className='flex flex-col lg:flex-row gap-[1.85rem]'>
      ...
      <Link href="/">
              ...
              <Image
                ...
                width={65}
                alt="nemitt logo"
              /> <span className="text-[1.02rem] md:text-[2rem] font-medium	text-grey_6">Confam Money</span>
                </a>
              </Link>   
              <p className='text-white text-[0.875rem] md:text-[1.25rem] max-w-[278.85px] md:max-w-[433.13px]'>Download Confam Money App today to transact safely with our peer-to-peer escrow-service payment platform. Stay on track and experience true business security!</p> 
    ...
    <p className='text-grey_3 text-[0.875rem] md:text-[1.125rem]'>© 2022 Confam Money. All rights reserved</p>
    </div>
    </div>
  )
}
